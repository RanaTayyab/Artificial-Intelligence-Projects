...
public class Application {
        ...
        while(!gameOver){
            try {
                ...
                if (input.equalsIgnoreCase("Q") || input.equalsIgnoreCase("QUIT")) {
                    ...
                    {
                    	boolean hello = MiniMax(chessGame, currentPlayer);
                    	// System.out.println(chessGame.getChessBoard().toString());
    ...
    private static boolean MiniMax(ChessGame chessGame, String currentPlayer) {
    	
        System.out.println("THIS COMPUTER IS "+currentPlayer);
        Scanner scanner = new Scanner(System.in);
        int MaxDepth;
        System.out.println("Enter the MAXIMUM DEPTH..");
        MaxDepth = scanner.nextInt();
        
        L144316 l144316 = new L144316();
        
		l144316.decideMoveUsingMinimax(chessGame, MaxDepth, currentPlayer);
       
    
        System.out.println("ENDDDDDDDDDDDDDD "+currentPlayer);
		return true;
